...
var FireBaseService = /** @class */ (function () {
    function FireBaseService(iErrorService) {
    ...
    FireBaseService.prototype.updateImage = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var files, _id;
            var _this = this;
            return __generator(this, function (_a) {
                files = params.files, _id = params._id;
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        files.forEach(function (file) {
                            ...
                            // create path 
                            var fileUpload = _this.bucket.file("/BookImages/" + _id + "/" + fileName);
                            // upload image
                            var uuid = uuid_1.v4();
                            var metadata = {
                            ...
                            blobStream.on('error', function (error) {
                                _this._iErrorService.firebase.requestFireBaseInvalid(error);
                            });
                            blobStream.on('finish', function () {
                                urls.push(_this.getPublicUrl({
                                    fileName: fileName,
                                    _id: _id,
                                    uuid: uuid
                                }));
    ...
    FireBaseService.prototype.getPublicUrl = function (params) {
        var fileName = params.fileName, _id = params._id, uuid = params.uuid;
